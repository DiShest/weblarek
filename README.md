https://github.com/DiShest/weblarek
...
- валидацию данных покупателя;
- очистку данных формы.
...
Приложение получает данные товаров с удалённого сервера через класс `Api`.
